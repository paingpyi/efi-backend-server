        ...
        if (Str::lower($data['locale']) == 'en-us') {
            ...
            $response = [
                ...
                'gallery' => [
                    'title' => 'Project Photos',
                    'image' => [
                        config('app.url') . '/storage/photos/1/stock-images/Short term endownment 02.jpg',
                        config('app.url') . '/storage/uploads/demo/kid-on-lap.jpg',
                        config('app.url') . '/storage/uploads/demo/news.jpg',
                    ],
                ]
            ];
        } else {
