                                    ...
                                    <div class="tab-pane fade pt-3" id="nav-zh" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title_chinese"
                                                value="{{ old('title_chinese', isset($news->title_chinese) ? $news->title_chinese : null) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="content_chinese" class="summernote" required
                                                id="content_chinese">{{ old('content_chinese', isset($news->content_chinese) ? $news->content_chinese : '') }}</textarea>
                                        </div>
