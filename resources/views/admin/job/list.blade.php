                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <form
                                                ...
                                                <div class="btn-group">
                                                    <button type="submit"
                                                        class="btn {{ $job->is_vacant ? 'btn-success' : 'btn-danger' }}">{!! $job->is_vacant
    ? '<i
                                                    class="fas fa-check-square"></i> Vacant'
    : '<i class="fas fa-square"></i> Closed' !!}</button>
                                                    <button type="button"
                                                        class="btn {{ $job->is_vacant ? 'btn-success' : 'btn-danger' }} dropdown-toggle dropdown-toggle-split"
                                                        data-toggle="dropdown" aria-expanded="false">
                                                        <span class="sr-only">Toggle Dropdown</span>
                                                    </button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="{{ route('edit#job', Illuminate\Support\Facades\Crypt::encryptString($job->id)) }}">Edit</a>
                                                        <button type="submit"
                                                            class="dropdown-item">{{ $job->is_vacant ? 'Close' : 'Vacant' }}</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </td>
