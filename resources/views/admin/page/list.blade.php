                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <form
                                                ...
                                                <div class="btn-group">
                                                    <button type="submit"
                                                        class="btn {{ $page->is_active ? 'btn-success' : 'btn-danger' }}">{!! $page->is_active
    ? '<i
                                                    class="fas fa-check-square"></i> Active'
    : '<i class="fas fa-square"></i> Deactivated' !!}</button>
                                                    <button type="button"
                                                        class="btn {{ $page->is_active ? 'btn-success' : 'btn-danger' }} dropdown-toggle dropdown-toggle-split"
                                                        data-toggle="dropdown" aria-expanded="false">
                                                        <span class="sr-only">Toggle Dropdown</span>
                                                    </button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="{{ route('edit#page', Illuminate\Support\Facades\Crypt::encryptString($page->id)) }}">Edit</a>
                                                        <button type="submit"
                                                            class="dropdown-item">{{ $page->is_active ? 'Deactivate' : 'Activate' }}</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </td>
